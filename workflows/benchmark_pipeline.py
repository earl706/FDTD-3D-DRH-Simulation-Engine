...
from cli import BENCHMARK_GRID_SIZES_DEFAULT, BENCHMARK_TIME_STEPS_DEFAULT
from segmentation_loader import load_segmentation_for_benchmark
from fdtd_solver import _run_minimal_fdtd_benchmark
...
def run_benchmark(args, paths, engine_script_path, write_progress_cb=None):
    """
    ...
    results = []
    engine_dir = os.path.dirname(engine_script_path)
    ...
    plot_script = os.path.join(engine_dir, "plot_scalability_benchmark.py")
