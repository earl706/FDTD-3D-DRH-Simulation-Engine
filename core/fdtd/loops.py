...
from core.fdtd import kernels
from core.fdtd import boundaries

try:
    from sar_computation import compute_instantaneous_sar
except ImportError:
    try:
        from core.metrics.sar import compute_instantaneous_sar
    except ImportError:
