...
from hermes_drh.compat.sar_computation import compute_robust_objective, compute_sar
from hermes_drh.compat.thermal_solver import solve_steady_bioheat_3d
from hermes_drh.settings.anatomy_config import get_anatomy_config
from hermes_drh.compat.voxel_model import K_TISSUE, TISSUE_TABLE, build_material_arrays
from hermes_drh.optimization.antenna import run_antenna_optimization_block
from hermes_drh.io.performance import get_peak_memory_mb
from hermes_drh.segmentation.loader import (
    load_segmentation_and_output_base,
    _find_modalities_in_dir,
)
from hermes_drh.visualization.multiview import saved_timesteps_for_run
...
def run_simulation(args, paths, write_progress_cb, anatomy="brain"):
    ...
    if anatomy == "brain":
        ...
        from hermes_drh.segmentation.brain import select_slices_biggest_tumor
        ...
        if use_modalities:
            from hermes_drh.segmentation.brain import (
        ...
        if anatomy == "cervix":
            from hermes_drh.segmentation.loader import load_cervix_segmentation_for_pipeline

            labels_3d, OUTPUT_BASE, t_end_segmentation = (
                load_cervix_segmentation_for_pipeline(args)
            )
        else:
            from hermes_drh.segmentation.loader import load_breast_segmentation_for_pipeline
